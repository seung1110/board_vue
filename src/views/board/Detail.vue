<template>
  <div>
    ...
    <v-list class="text-center" v-if="board==null">
      <v-list-item>
        <v-list-item-subtitle class="text-h5 red--text">로그인 후 확인할 수 있습니다.</v-list-item-subtitle>
      </v-list-item>
      <v-btn to="/user/login" color="info">로그인 페이지 이동</v-btn>
    </v-list>
  </div>
</template>
